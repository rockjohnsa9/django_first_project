    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_intor', models.CharField(blank=True, max_length=200, null=True)),
                ('bio', models.TextField(blank=True, null=True)),
                ('profile_image', models.ImageField(blank=True, default='profile/user-default.png', null=True, upload_to='', verbose_name=helpers.upload_file_name.content_file_name)),
